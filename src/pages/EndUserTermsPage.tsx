      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              These End-User Terms of Service ("End-User Terms") govern your use of services provided by               {process.env.REACT_APP_COMPANY_NAME} when you interact with our travel membership platform and booking services.
            </LegalParagraph>
            <LegalParagraph>

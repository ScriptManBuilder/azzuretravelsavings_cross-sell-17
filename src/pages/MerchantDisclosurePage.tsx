      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Primary Descriptor:</strong> "AZZURE TRAVEL" or "AZZ*[Travel Service]"
              </LegalListItem>
              <LegalListItem>
                <strong>Alternative Descriptors:</strong> May include "AZZURE PERKS" or travel provider names for specific bookings
              </LegalListItem>
              <LegalListItem>
